...
export const cart_time = () => async dispatch => {
    ...
    try{
    const res = await axios.get(`${BASE_URL}/cart/time/`, config)
...
export const server_time = () => async dispatch => {
    ...
    try{
        const res = await axios.get(`${BASE_URL}/cart/time/now/`, config)
...
export const cart_detail = () => async dispatch => {
    ...
    try{
        const res = axios.get(`${BASE_URL}/cart/detail/`, config)
        if(res.data){
            dispatch({
